...
const appSettingSlice = createSlice({
  ...
  reducers: {
    ...
    toggleContentMode: (state) => {
      state.contentMode = state.contentMode === 'compact' ? 'full' : 'compact';
    },
  },
});

export const { saveAppSetting, toggleFileTree, toggleOutline, toggleContentMode } = appSettingSlice.actions;
